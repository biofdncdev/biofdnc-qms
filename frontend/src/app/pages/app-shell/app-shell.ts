  ...
  private buildMenus() {
    ...
    if (!this.isViewer) {
      this.menus.push(
        ...
        { key: 'product', icon: 'category', label: 'Product', submenu: [ { label: '제품목록', path: '/app/product' }, { label: '제품 조성비 등록', path: '/app/product/form' }, { label: '제품목록 업데이트', path: '/app/product/update' } ] },
        {
